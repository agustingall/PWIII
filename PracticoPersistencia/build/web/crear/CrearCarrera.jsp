...
<body>
	...
	<div class="container mt-3">
		<h2 class="h2 text-center text-primary ">Crear Carrera</h2>
		<form method="POST" class="mt-3 row d-flex flex-column justify-content-center align-items-center" action="AgregarCarrera">
		    ...
		    <div class="col-sm-10">
		      <input type="number"  class="form-control" id="id" name="id" >
                    ...
                    <div class="row mb-3 col-8">
		    <label for="nombre" class="col-sm-2 col-form-label">Carrera</label>
		    <div class="col-sm-10">
		  ...
		  <div class="row mb-3 col-8">
		    <label for="idFacultad" class="col-sm-2 col-form-label">Facultad</label>
		    <div class="col-sm-10">
                        <select class="form-select" aria-label="Default select example" id="idFacultad" name="idFacultad">
                          <c:forEach var="articulo" items="${lista}">
                              <option value="<c:out value="${articulo.getIdfacultad()}"/>" ><c:out value="${articulo.getNombre()}"/></option>
                          </c:forEach>
			</select>
		    </div>
		  </div>
				  
		  <button type="submit" class="btn btn-primary col-4">Crear Carrera</button>
	</form>
	</div>
