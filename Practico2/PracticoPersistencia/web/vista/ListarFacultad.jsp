...
<head>
	...
	<link rel="icon" type="image/svg+xml"  href="/../static/img/icono.svg" sizes="any">
	...
	<div class="container w-75 .flex-wrap">
		...
		<header class="row mt-1  ml-0">
			<div class="row col-12 col-md-2 icono justify-content-center">
				<img src="https://cdn.pixabay.com/photo/2019/12/14/07/21/mountain-4694346_960_720.png" class="img-fluid" alt="Responsive image col-12 " class="img-fluid" alt="Responsive image col-12 ">
			</div>
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
				<td><c:out value="${articulo.getIdfacultad()}"/></td>
